...
const Footer = () => {
  return (
    <footer className=" text-white ">
      <div className="bg-[#2A9BA0] text-white py-5">
      ...
      {/* Divider */}
      <div className="border-t container mx-auto border-white/20 py-6 ">
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-black/70">

    ...
    const data=[
        {
            ...
            description:"Every DoUndo game is a story you can play.  Each title has its own character and  purpose. Some are already here, like  DoUndo, a psychological and deduction  duel. Others are still in the making, like a  puzzle for solo thinkers or a party game full  of chance and laughter. All of them are  designed to leave their mark and bring  people together."
        },
        {
            title:"Simple to Learn, Rich in Experience",
            description:"Our games can be learned in minutes.  Some open into layers of strategy and  discovery, while others bring joy, surprise,  and the kind of laughter that turns time into  memory."
        },
        {
            title:"A Growing Universe",
            description:"DoUndo doesn’t stop at one game. We are  creating new board games, and exploring  apparel, accessories, and digital projects.  Some ideas are already here, and others  Independent and Vision-Driven  As an independent Canadian studio, we are free from the limits of mass-market formulas. Each project  comes from careful craft, imagination, and a desire to do things differently."
        },
        {
            title:"Shared Moments",
            description:"Games are about people, not just pieces. What matters most is the time spent together, the laughs, the  choices, the memories. DoUndo is made to create those moments you’ll want to keep."
        },  
    ]
  return (
